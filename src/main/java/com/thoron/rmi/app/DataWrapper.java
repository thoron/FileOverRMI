...
public class DataWrapper {
    ...
    public DataWrapper(File f, int chunkSize) {
        this(f, chunkSize, null);
    }
    ...
    public DataWrapper(File f, int chunkSize, String fileExtension) {
        ...
        this.fileExtension = (this.fileExtension.startsWith(".") ? "" : ".") + this.fileExtension;
        try {
    ...
    public DataWrapper(RemoteFileTransfer t, int chunkSize) {
        this(t, chunkSize, null);
    }
    ...
    public File getFile(transferType t) {
        return getFile(t, null);
    }
